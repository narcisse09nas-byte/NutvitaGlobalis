...
const spaces = [
  ...
  { title: "NutriTrack", text: "Application de support a la prise en charge integree de la malnutrition aigue.", href: "/acces-nutritrack", action: "Demander ou ouvrir un acces", icon: BuildingOffice2Icon, tone: "bg-cyan-50 text-cyan-700" },
] as const;
