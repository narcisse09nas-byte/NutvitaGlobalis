...
export default async function RecruitmentAdmin(){
  ...
  const [{data:applications},{data:questions},{data:attempts},{data:settings}]=await Promise.all([
  ...
  return <AdminShell name={admin.full_name||admin.email}>
    ...
    <TestConfigManager initialSettings={settings} initialQuestions={questions||[]}/>
