...
export default async function NutritionRecordPage() {
  ...
  const [{ data: anthropometry }, { data: biology }, { data: food }, { data: lifestyle }, { data: consultations }] = await Promise.all([
