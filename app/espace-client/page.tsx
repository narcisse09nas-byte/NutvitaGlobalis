...
export default async function ClientHome(){
 ...
 return <ClientShell email={user.email||""} service="client"><ClientServiceLanding name={profile?.full_name||user.user_metadata.full_name||""} choices={access.choices.map(({service,role,roleLabel,href})=>({service,role,roleLabel,href}))}/></ClientShell>
}