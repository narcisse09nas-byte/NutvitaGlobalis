...
export default async function TrendsPage(){
  ...
  const [{data:anthropometry},{data:biology},{data:food},{data:wellness},{data:laboratory}]=await Promise.all([
