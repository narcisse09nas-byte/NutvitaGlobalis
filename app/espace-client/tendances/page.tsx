...
export default async function TrendsPage(){
  ...
  return <ClientShell email={user.email||""}><div className="mb-7"><h1 className="text-3xl font-black">{en?"Health dashboards and trends":"Tableaux de bord et tendances"}</h1><p className="mt-2 text-slate-500">{en?"All recorded variables are displayed; use filters to customize the view.":"Toutes vos variables renseignÃ©es sont visibles; utilisez les filtres pour personnaliser lâ€™affichage."}</p></div><HealthTrendsDashboard anthropometry={anthropometry||[]} biology={biology||[]} food={food||[]} wellness={wellness||[]} locale={locale}/></ClientShell>
}