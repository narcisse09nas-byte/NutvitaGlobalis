...
export default async function SuperAdminPage() {
  ...
  const links = [
    { title: "Administration FOSA", text: "Examiner les demandes, approuver les organisations et superviser l'acces au service.", href: "/admin/fosa", icon: BuildingOffice2Icon, tone: "bg-teal-50 text-teal-700" },
