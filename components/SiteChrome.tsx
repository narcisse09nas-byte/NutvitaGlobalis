...
export default function SiteChrome({children}:{children:React.ReactNode}) {
  ...
  const privateArea = cleanPath.startsWith("/admin") || cleanPath.startsWith("/super-admin") || cleanPath.startsWith("/nutritrack") || cleanPath.startsWith("/candidat") || cleanPath.startsWith("/partenaire") || cleanPath.startsWith("/espace-client") || cleanPath.startsWith("/checkout") || cleanPath === "/inscription" || cleanPath === "/connexion" || cleanPath === "/mot-de-passe-oublie";
