...
export default function SignupFields(){return <>
  ...
  <label className="flex gap-3 text-sm"><input name="terms" type="checkbox" required className="mt-1 h-4 w-4"/>J'accepte les <Link href="/cgu" target="_blank" className="font-bold text-leaf">conditions generales</Link>.</label>
