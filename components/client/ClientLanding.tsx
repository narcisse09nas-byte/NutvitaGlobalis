...
export default function ClientLanding({
  ...
  const services: Service[] = [
    ...
    { key: "teleconsultation", role: "client", title: "Téléconseils nutritionnels", description: "Consultations, messagerie et appels vidéo.", href: "/espace-client/consultations", active: access.teleconsultation, icon: ChatBubbleLeftRightIcon },
