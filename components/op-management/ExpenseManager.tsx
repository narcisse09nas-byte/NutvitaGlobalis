      ...
      <DecisionForm
        ...
        onConfirm={async (fields) => {
          ...
          if (deciding.nextStatus === "posted" && deciding.row.procurement_item_id) {
            ...
            const receiptAllowsPayment = ["complete", "received_with_reservations", "closed_with_cancelled_balance"].includes(po?.receipt_status || "pending_delivery");
