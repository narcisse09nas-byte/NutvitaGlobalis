  ...
  },
  {
    ...
    fr: {
      ...
      sections: [
        ...
        { title: "Paiement", body: "Les paiements sont traites par nos prestataires de paiement CinetPay (carte bancaire, mobile money) et PayPal, ou tout autre canal explicitement active. L'acces au service peut etre suspendu en cas d'echec ou d'annulation de paiement." },
    ...
    en: {
      ...
      sections: [
        ...
        { title: "Payment", body: "Payments are processed by our payment providers CinetPay (card, mobile money) and PayPal, or any other explicitly activated channel. Service access may be suspended after failed or cancelled payment." },
  ...
  },
  {
    ...
    fr: {
      ...
      sections: [
        ...
        { title: "Sous-traitants et destinataires des donnees", body: "Certaines donnees sont partagees avec des prestataires necessaires au fonctionnement du service : Supabase (hebergement et base de donnees), CinetPay et PayPal (traitement des paiements), Resend (emails transactionnels et newsletter), des fournisseurs d'intelligence artificielle (generation de rapports informatifs) et une solution de visioconference (teleconsultation). Ces prestataires n'accedent qu'aux donnees necessaires a leur mission et sont tenus a des obligations de confidentialite et de securite." },
        { title: "Stockage", body: "Les donnees sont stockees et hebergees via Supabase, dans des environnements techniques selectionnes pour leur securite et leur compatibilite avec les besoins de la plateforme." },
    ...
    en: {
      ...
      sections: [
        ...
        { title: "Subprocessors and data recipients", body: "Some data is shared with providers required to operate the service: Supabase (hosting and database), CinetPay and PayPal (payment processing), Resend (transactional emails and newsletter), artificial intelligence providers (generation of informational reports) and a video-conferencing solution (teleconsultation). These providers only access the data necessary for their task and are bound by confidentiality and security obligations." },
        { title: "Storage", body: "Data is stored and hosted via Supabase, in technical environments selected for security and compatibility with platform needs." },
