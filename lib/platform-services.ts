...
export const platformServices: PlatformService[] = [
  ...
  { key: "academy", title: "NutVitaGlobalis Academy", description: "Formations, Ã©valuations, classes et certificats.", roles: [{ key: "student", label: "Apprenant", href: "/api/academy/sso?role=student" }, { key: "instructor", label: "Formateur", href: "/api/academy/sso?role=instructor" }, { key: "admin", label: "Administration Academy", href: "/api/academy/sso?role=admin" }] },
  { key: "health", title: "Application de suivi santÃ© personnalisÃ© pour enfants (suivi de la croissance) et adultes", titleEn: "Personalized health monitoring application for children (growth monitoring) and adults", description: "Dossier, tendances, analyses et rapports.", roles: [{ key: "client", label: "Client", href: "/espace-client/dossier" }, { key: "nutritionist", label: "Nutritionniste", href: "/partenaire/clients" }, { key: "admin", label: "Administration santÃ©", href: "/admin/sante" }] },
  { key: "child_growth", title: "Croissance enfant", description: "Mesures, courbes et analyses pÃ©diatriques.", roles: [{ key: "client", label: "Parent", href: "/espace-client/croissance-enfant" }, { key: "nutritionist", label: "Nutritionniste", href: "/partenaire/clients" }, { key: "admin", label: "Administration croissance", href: "/admin/croissance-enfant" }] },
  { key: "teleconsultation", title: "TÃ©lÃ©conseils", description: "Consultations, messages et appels vidÃ©o.", roles: [{ key: "client", label: "Client", href: "/espace-client/consultations" }, { key: "nutritionist", label: "Nutritionniste", href: "/partenaire/consultations" }, { key: "admin", label: "Administration tÃ©lÃ©conseils", href: "/admin/teleconseils" }] },
  { key: "survey", title: "Application de support aux enquÃªtes de sÃ©curitÃ© alimentaire et nutrition", titleEn: "Food security and nutrition survey support application", description: "Conception, collecte, analyse et rapports dâ€™enquÃªte.", roles: [{ key: "client", label: "Utilisateur", href: "/surveys" }, { key: "admin", label: "Administration", href: "/surveys" }] },
  { key: "project_management", title: "Application de support Ã  la gestion des projets, programmes et portefeuilles", titleEn: "Project, programme and portfolio management support application", description: "Pilotage des projets, programmes et portefeuilles.", roles: [{ key: "client", label: "Utilisateur", href: "/op-management" }, { key: "admin", label: "Administration", href: "/op-management" }] },
  ...
  { key: "administration", title: "Administration NutVitaGlobalis", description: "Configuration et contrÃ´le transversal de la plateforme.", roles: [{ key: "super_admin", label: "Super administrateur", href: "/admin" }] },
];
