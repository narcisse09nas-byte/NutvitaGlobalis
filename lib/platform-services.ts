...
export type PlatformServiceKey = "client" | "academy" | "health" | "child_growth" | "teleconsultation" | "nutritrack" | "maximus" | "administration";
export type PlatformRole = "client" | "student" | "nutritionist" | "instructor" | "admin" | "super_admin";
...
export const platformServices: PlatformService[] = [
  ...
  { key: "maximus", title: "Maximus", description: "Gestion intégrée des opérations et programmes.", roles: [{ key: "client", label: "Collaborateur", href: "/maximus" }, { key: "admin", label: "Administration Maximus", href: "/maximus" }] },
