...
export const platformServices: PlatformService[] = [
  ...
  { key: "academy", title: "NutVitaGlobalis Academy", description: "Formations, Ã©valuations, classes et certificats.", roles: [
  ...
  { key: "survey", title: "Application de Support aux enquetes de securite alimentaire et nutrition.", titleEn: "Food security and nutrition survey support application.", description: "Conception, collecte, analyse et rapports dâ€™enquÃªte.", roles: [{ key: "client", label: "Utilisateur", href: "/surveys" }, { key: "admin", label: "Administration", href: "/surveys" }] },
  { key: "project_management", title: "Application de support a la gestion des projets, programmes et portefeuilles", titleEn: "Project, programme and portfolio management support application", description: "Pilotage des projets, programmes et portefeuilles.", roles: [{ key: "client", label: "Utilisateur", href: "/op-management" }, { key: "admin", label: "Administration", href: "/op-management" }] },
