...
export type AssessmentResult = { score:number; rawScore:number; maxScore:number; level:"very_low"|"low"|"moderate"|"good"|"excellent"; levelLabel:string; interpretation:string; completed:boolean; keySignals:Array<{question:string;score:number}> };
