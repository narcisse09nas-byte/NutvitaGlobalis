...
values
('health-autonomous-yearly','Suivi sante autonome','basic','yearly',10000,'XOF','["Acces annuel renouvelable","Tableau de bord de suivi","Visualisation automatique de la progression","Analyses informatives","Rapports et recommandations"]',true,'health_tracking',12,10000),
('health-autonomous-premium-yearly','Suivi sante autonome premium','premium','yearly',15000,'XOF','["Acces annuel renouvelable","Tout le suivi autonome standard","Analyse intelligente de vos donnees de sante","Visualisation claire et automatique de votre progression","Accompagnement trimestriel par un teleconseiller qualifie","Acces aux articles et ressources premium","Suivi utilisable sur ordinateur et smartphone","Rapports et recommandations prioritaires"]',true,'health_tracking',12,15000),
('child-growth-yearly','Suivi croissance enfant','basic','yearly',10000,'XOF','["Acces annuel renouvelable","Courbes de croissance","Historique des mesures","Analyses informatives","Conseils aux parents","Possibilite d ajouter l enfant apres activation"]',true,'child_growth',12,10000),
('child-growth-premium-yearly','Suivi croissance enfant premium','premium','yearly',15000,'XOF','["Acces annuel renouvelable","Tout le suivi croissance standard","Analyse intelligente des donnees de croissance","Visualisation claire et automatique de la progression","Accompagnement trimestriel par un teleconseiller qualifie","Acces aux articles et ressources premium","Suivi utilisable sur ordinateur et smartphone","Rapports et recommandations prioritaires","Possibilite d ajouter l enfant apres activation"]',true,'child_growth',12,15000)
