...
insert into public.site_pages(
  ...
  $j$[
    {"badge":"hero-checklist","title":"","text":"Planifiez. Exécutez. Suivez. Atteignez vos objectifs.","items":["Approche PMBOK® complète|||De l'initiation à la clôture","Rapports intelligents avec IA|||Analyses et recommandations","Tableaux de bord interactifs|||Indicateurs en temps réel","Collaboration et traçabilité|||Toutes les données au même endroit"]},
  ...
  $j$[
    {"badge":"hero-checklist","title":"","text":"Plan. Execute. Track. Reach your goals.","items":["Complete PMBOK® approach|||From initiation to closure","Smart AI-powered reports|||Analyses and recommendations","Interactive dashboards|||Real-time indicators","Collaboration and traceability|||All data in one place"]},
